...
config :test_phoenix_app, TestPhoenixAppWeb.Endpoint,
  ...
  secret_key_base: "V4M7cPTnfKu/qNHVqjo3R/R6x1cuypQgAxjmXX0Lk5y1Pmuzmn2EnXNdl/bbr0p/",
  server: false

# In test we don't send emails.
config :test_phoenix_app, TestPhoenixApp.Mailer, adapter: Swoosh.Adapters.Test
